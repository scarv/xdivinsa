...
# Function:
#   Generate a vivado project for the picorv32 SoC on sakura X board
...
set files [list \
			...
			[file normalize $work_dir/$project_name/rtl_sources/picorv32.v] \
